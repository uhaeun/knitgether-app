...
- 원격 대비 상태: `main...origin/main [ahead 8]` — 아직 push 전

## 베이스라인 확정 상태

- 2026-07-19 기준 미커밋 변경사항 없음.
- 아래 8개 커밋을 QA 베이스라인으로 사용한다.
...
| iOS UI | `xcodebuild test ... -only-testing:KnitGetherUITests` | PASS, 5 tests / 8 passed runs |
...
- 아직 자동화되지 않은 P0 후보: 로그인 재진입, 프로젝트 수정/삭제, 작업공간 단수/작업시간, 오프라인 재시도, 계정 전환.
