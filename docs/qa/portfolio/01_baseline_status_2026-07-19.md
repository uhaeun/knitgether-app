...
- 원격 대비 상태: `main...origin/main [ahead 13]` — 아직 push 전

## 베이스라인 확정 상태

- 2026-07-19 기준 미커밋 변경사항 없음.
- 아래 13개 커밋을 QA 베이스라인으로 사용한다.
...
| iOS UI | `xcodebuild test ... -only-testing:KnitGetherUITests` | PASS, 12 tests / 15 passed runs |
